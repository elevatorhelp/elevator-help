...
- If the user asks for a minimum but the verified facts only establish maximum permissible distances, explicitly say that the verified provisions are maximum limits, not minimum values. Do not claim that no minimum exists elsewhere unless the verified facts establish that.
...
- For distance/clearance questions, distinguish each physical interface; do not merge car-to-wall, sill-to-sill, door-edge or car-roof clearances into one requirement.
